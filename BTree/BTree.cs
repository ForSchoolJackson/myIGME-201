...
namespace BTree
{
    public partial class BTreeForm : Form
    {
        ...
        private void Exercise2__Click(object sender, EventArgs e)
        {
            ...
            // Your code here
            int[] optimallyDistributedValues = { 25, 12, 37, 6, 18, 31, 43 };

            foreach (int value in optimallyDistributedValues)
            {
                root = new BTree(value, root, isData: false);
            }
