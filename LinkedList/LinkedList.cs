    ...
    public partial class LinkedList : Form
    {
       ...
       */
        ...
        private void Button4__Click(object sender, EventArgs e)
        {
            ...
            // 2. Your code here
            string song = "Because I'm sad Clap along if you feel like a room without a roof";
            song += " Because I'm sad Clap along if you feel like sadness is the truth sad";
            s = song.Split(' ');
        ...
        private void Button5__Click(object sender, EventArgs e)
        {
            ...
            // 2. Your code here
            string peom = "The Spain in rain falls plain on the mainly";
            s = peom.Split(' ');
            linkedList = new LinkedList<object>(s);
