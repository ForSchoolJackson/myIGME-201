...
namespace WordSort
{
    class Program
    {
        ...
        start:
            Console.WriteLine("Enter sentance that will be put in alphebetical order");

            // read the space-separated sentance
            string sSentance = Console.ReadLine();

            // split the string into the an array of strings which are the individual words
            string[] sWord = sSentance.Split(' ');
        ...
        // find the lowest word alphebetically
        ...
        //find the highest word alphebetically
